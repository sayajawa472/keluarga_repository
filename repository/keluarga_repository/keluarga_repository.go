...
type KeluargaRepository interface {
	...
	Update(ctx context.Context, id int32, keluarga entity.Keluarga) (entity.Keluarga, error)
	Delete(ctx context.Context, keluarga entity.Keluarga) (entity.Keluarga, error)
}
