...
type PerlengkapanSekolah interface {
	...
	Update(ctx context.Context, Nama, Bahan entity.Perlengkapan_sekolah) (entity.Perlengkapan_sekolah, error)
	Delete(ctx context.Context, fungsi, harga entity.Perlengkapan_sekolah) (entity.Perlengkapan_sekolah, error)
}
