...
type PenyanyiFavorit interface {
	...
	Update(ctx context.Context, favorit entity.Penyanyi_favorit) (entity.Penyanyi_favorit, error)
	Delete(ctx context.Context, Id int32) (entity.Penyanyi_favorit, error)
}
